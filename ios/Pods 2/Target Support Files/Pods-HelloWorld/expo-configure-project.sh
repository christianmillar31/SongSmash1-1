...
with_node \
  ...
  --target "/Users/christianmillar/Documents/SongSmash1-1/ios/Pods/Target Support Files/Pods-HelloWorld/ExpoModulesProvider.swift" \
   \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-audio" "expo-av" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linking" "expo-secure-store" "expo-web-browser"
